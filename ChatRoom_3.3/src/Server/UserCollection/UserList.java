...
public abstract class UserList implements Serializable {
	...
	public abstract void loginFileSocket(String linkName, Socket socket);
	
	public abstract void logoutFileSocket(String linkName);
	
	public abstract HashMap<String, Socket> getFileSocketsMap();
	
	public abstract void loginSoundSocket(String linkName, Socket socket);
	
	public abstract void logoutSoundSocket(String linkName);
	
	public abstract HashMap<String, Socket> getSoundSocketsMap();
}
