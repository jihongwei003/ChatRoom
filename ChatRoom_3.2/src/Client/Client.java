...
public class Client {
	...
	public void runClient() {
		try {
			...
			ResponseHandler resSendFileHandler = new ResSendFileHandler(socket, fileSocket);
			ResponseHandler resReceiveFileHandler = new ResReceiveFileHandler(socket, fileSocket);
